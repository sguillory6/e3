...
@click.option('-desired', '--desired', required=True, default=1, help='Number of instance in scaling group')
@click.option('-max', '--max_size', required=False, default=1, help='Number of max instance in scaling group')
@click.option('-min', '--min_size', required=False, default=1, help='Number of min instance in scaling group')
